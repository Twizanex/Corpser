...
function pages_get_navigation_tree($container) {
	...
	$top_pages = elgg_get_entities_from_metadata(array(
		'type' => 'object',
		'metadata_names' => array('draft'),
		'metadata_values' => array('publish'),
		'subtype' => 'page_top',
	...
	foreach ($top_pages as $page) {
		...
		while (count($stack) > 0) {
			...
			$children = elgg_get_entities_from_metadata(array(
				'type' => 'object',
				'subtype' => 'page',
				'metadata_names' => array('parent_guid', 'draft'),
				'metadata_values' => array($parent->getGUID(), 'publish'),
				'limit' => 0,
			));
