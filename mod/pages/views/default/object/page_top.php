...
if($page->storytype=='normal'){
   $storytype = elgg_echo('pages:shortnormal');}
if($page->storytype=='exqcorpse'){
   $storytype = elgg_echo('pages:exquisitecorpse');}
if($page->storytype=='Gamebook'){
   $storytype = elgg_echo('pages:gamebook');}
...
$subtitle = "$storytype $editor_text $comments_link $categories";
