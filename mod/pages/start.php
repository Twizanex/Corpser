...
function pages_init() {
	...
	$item = new ElggMenuItem('pages', '<img src="http://localhost/sites/elgg/icon1.png">', 'pages/all');
	...
	elgg_register_action("pages/continue", "$action_base/pages/continue.php");
	...
	elgg_register_action("pages/resendinvitation", "$action_base/pages/resendinvitation.php");
	elgg_register_action("pages/killinvitation", "$action_base/pages/killinvitation.php");
	elgg_register_action("pages/killrequest", "$action_base/pages/killrequest.php");
	elgg_register_action("pages/acceptrequest", "$action_base/pages/acceptrequest.php");
	elgg_register_action("pages/sendinvitation", "$action_base/pages/sendinvitation.php");
	...
	elgg_register_entity_type('storylock', 'storylock');
	...
	register_notification_object('object', 'storylock', elgg_echo('pages:storylocknew'));
...
function pages_page_handler($page) {
	...
	switch ($page_type) {
		...
		case 'invitations':
			set_input('guid', $page[1]);
			include "$base_dir/invitations.php";
			break;
		case 'requestparticipation':
			set_input('guid', $page[1]);
			include "$base_dir/requestparticipation.php";
			break;
		case 'acceptinvitation':
			set_input('guid', $page[1]);
			include "$base_dir/acceptinvitation.php";
			break;
		case 'invitationrequests':
			include "$base_dir/invitationrequests.php";
			break;
		case 'resendinvitation':
			include "$base_dir/resendinvitation.php";
			break;
		case 'details':
			set_input('guid', $page[1]);
			include "$base_dir/details.php";
			break;
		case 'add':
			set_input('guid', $page[1]);
