<?php
	...
	foreach ($variables as $name => $type) {
		...
		if (($name == "parent_guid") && (!$vars["parent_guid"])) {
			$canchoosestorytype = true;
		}
		...
		else
		{
		  if(!$vars["parent_guid"]){
		    echo "<div>";
		    echo "<label>" . elgg_echo("pages_tools:intro") . "</label>";
		  }
		  else
		  {
		    echo "<div>";
		    echo "<label>" . elgg_echo("pages_tools:content") . "</label>";
		  }
		}
	...
	$anychildren = pages_tools_get_ordered_children($page);
	
	if ($canchoosestorytype && !$anychildren){
	     echo "<div>";
	     echo "<label>" . elgg_echo("pages_tools:story_type") . "</label>";
	     echo "<br />";
